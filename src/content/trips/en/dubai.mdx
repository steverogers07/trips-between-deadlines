...
totalCost: 12000
currency: "INR"
coverImage: "/images/trips/dubai/cover.jpg"
gallery: []
...
<figure>
  <img src="/images/trips/dubai/1.jpg" alt="Dubai Frame" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">The Dubai Frame — old Dubai on one side, new Dubai on the other</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/dubai/2.jpg" alt="Global Village, Dubai" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Global Village — a world fair with stalls from dozens of countries</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/dubai/3.jpeg" alt="Al Farooq Omar Bin Al Khattab Mosque" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Al Farooq Omar Bin Al Khattab Mosque — our first stop on the city tour</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/dubai/4.jpeg" alt="Palm Jumeirah" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Palm Jumeirah — the man-made island from the drive</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/dubai/5.jpeg" alt="View from the yacht" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">View from the yacht — cruising past the Dubai skyline at sunset</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/dubai/6.jpg" alt="View from Burj Khalifa" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">The view from the top of Burj Khalifa — the entire city laid out below</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/dubai/7.jpg" alt="Ferrari World, Abu Dhabi" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Ferrari World — home of the world's fastest roller coaster</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/dubai/8.jpeg" alt="Sheikh Zayed Grand Mosque, Abu Dhabi" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Sheikh Zayed Grand Mosque — one of the most beautiful buildings I've ever seen</figcaption>
</figure>

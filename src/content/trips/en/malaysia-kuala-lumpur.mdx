...
description: "4 days in KL — Batu Caves, KL Tower, Petronas Twin Towers at night, Genting Highlands gondola, Chin Swee Caves Temple by van from Awana SkyWay, and getting around on a budget."
date: 2024-08-14
...
totalCost: 12000
currency: "INR"
coverImage: "/images/trips/malaysia/cover.jpeg"
gallery: []
...
<figure>
  <img src="/images/trips/malaysia/1.jpeg" alt="Batu Caves, Kuala Lumpur" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Batu Caves — the rainbow steps up to the cave temples</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/malaysia/2.jpeg" alt="National Palace, Kuala Lumpur" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">National Palace (Istana Negara)</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/malaysia/3.jpeg" alt="KL Tower at night from Hop-on Hop-off bus" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">KL Tower from the City of Lights Hop-on Hop-off bus</figcaption>
</figure>

<figure>
  <img src="/images/trips/malaysia/6.jpeg" alt="Petronas Twin Towers at night" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Petronas Twin Towers lit up at night</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/malaysia/4.jpeg" alt="Petronas Twin Towers, Kuala Lumpur" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Petronas Twin Towers from our afternoon visit</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/malaysia/5.jpeg" alt="Chin Swee Caves Temple, Genting Highlands" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Chin Swee Caves Temple — quiet and scenic above the clouds</figcaption>
</figure>

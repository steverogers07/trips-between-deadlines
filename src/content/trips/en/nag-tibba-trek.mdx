...
totalCost: 4000
currency: "INR"
coverImage: "/images/trips/nag-tibba/cover.jpeg"
gallery: []
...
<figure>
  <img src="/images/trips/nag-tibba/1.jpeg" alt="Sunset on the way to Nag Tibba base camp" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Sunset skyline on the way up to base camp</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/nag-tibba/2.jpeg" alt="Bonfire at Nag Tibba base camp" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Bonfire at base camp — the best way to end the evening</figcaption>
</figure>

<figure>
  <img src="/images/trips/nag-tibba/3.jpeg" alt="Night sky at Nag Tibba" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Night sky from the base camp — clear December skies</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/nag-tibba/4.jpeg" alt="Sunrise from Nag Tibba summit" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Sunrise skyline from the Nag Tibba summit</figcaption>
</figure>

...
accommodation:
  - name: "Hotel in Pattaya"
    costPerNight: 1300
    rating: 3.5
    bookingLink: "https://maps.app.goo.gl/VuJEAWyL2jYzXY8i9"
    pros:
  ...
  - name: "Mad Monkey Hostel, Bangkok"
    ...
    currency: "THB"
    rating: 4
    bookingLink: "https://maps.app.goo.gl/hJnhFTwyjX7ss1s59"
    pros:
...
Phi Phi has a great party scene. We rested at the hotel for a bit, then went down to the beach and explored the cafes and bars along the waterfront.
...
| Item | Cost |
|------|------|
| Visa on Arrival | 2,000 Baht (~₹4,600) |
| SIM Card (Klook) | ~₹350 |

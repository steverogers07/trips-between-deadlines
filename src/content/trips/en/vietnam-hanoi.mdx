...
<figure>
  <img src="/images/trips/vietnam/2.jpeg" alt="Lotte Observation Deck, Hanoi" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Lotte Observation Deck — Hanoi from above</figcaption>
</figure>

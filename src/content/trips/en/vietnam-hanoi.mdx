...
totalCost: 15000
currency: "INR"
coverImage: "/images/trips/vietnam/cover.jpeg"
gallery: []
...
accommodation:
  - name: "Airbnb in Hanoi"
    ...
    pros:
      ...
      - "Affordable — ₹3,000/night for 4 people"
    cons:
      - "Charged extra for early check-in"
---

This was a trip with 3 friends — the same squad from the [Philippines trip](/en/trips/philippines-cebu-manila/). Vietnam had been on the radar for a while, and we decided to pair it with Kuala Lumpur (that's a [separate post](/en/trips/malaysia-kuala-lumpur/)). We spent 5 days in northern Vietnam — Hanoi as the base, with day trips to Halong Bay and Ninh Binh.
...
<figure>
  <img src="/images/trips/vietnam/1.jpeg" alt="Hanoi Train Street" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Train Street — a train squeezing past cafés and houses</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/vietnam/2.jpeg" alt="Lotte Center tower, Hanoi" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Lotte Center — the tower from street level (the observation deck is at the top)</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/vietnam/3.jpeg" alt="Halong Bay" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Halong Bay — limestone karsts from the cruise</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/vietnam/4.jpeg" alt="Sung Sot Cave, Halong Bay" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Sung Sot (Surprise) Cave — massive chambers inside the karsts</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/vietnam/5.jpeg" alt="Hoa Lu Ancient Citadel" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Hoa Lu Ancient Citadel — old capital against the limestone hills</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/vietnam/6.jpeg" alt="Trang An boat ride" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Trang An — boat ride through caves and karsts (King Kong country)</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/vietnam/7.jpeg" alt="Hang Mua viewpoint" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Hang Mua — view from the dragon-backed ridge above Ninh Binh</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/vietnam/8.jpeg" alt="Ho Chi Minh Mausoleum" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Ho Chi Minh Mausoleum — solemn from the outside; no photos inside</figcaption>
</figure>
...
<figure>
  <img src="/images/trips/vietnam/9.jpeg" alt="Temple of Literature, Hanoi" class="rounded-xl" />
  <figcaption class="text-sm text-center text-charcoal-light mt-2">Temple of Literature — Vietnam's first university, dating from 1070</figcaption>
</figure>
